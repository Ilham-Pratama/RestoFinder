...
jest.mock('shared/api/useBusinessReview', () => () => ({
  data: {
    reviews: [
      {
      ...
      },
      {
        ...
        user: {
          ...
          profile_url:
            'https://www.yelp.com/user_details?userid=rk-MwIUejOj6LWFkBwZ98Q',
          image_url: null,
          name: 'Yanni L.'
        },
      ...
      },
      {
        ...
        user: {
          ...
          profile_url:
            'https://www.yelp.com/user_details?userid=rpOyqD_893cqmDAtJLbdog',
          image_url: null,
          name: 'Suavecito M.'
        },
...
describe('BusinessReview', () => {
  it('renders BusinessReview', () => {
    const component = render(<BusinessReview {...BUSINESS_DUMMY} />);
    expect(component.toJSON()).toMatchSnapshot();
    expect(component.getAllByRole('header')[0].props).toHaveProperty(
      'children',
      'Reviews'
    );
